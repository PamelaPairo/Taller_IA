...
- Clase 1: Conceptos importantes. Clasificación vs. Regresión. Sobreajuste. Trade off Sesgo-Varianza. Entrenamiento, evaluación y testeo. Hiperparámetros. Regresión lineal y polinomial. Árboles de decisión. Ejercitación

- Clase 2: SVM. Regresión Logística. Random Forest. Naïve Bayes. Métricas. Ejercitación

- Clase 3: Validación cruzada. Redes neuronales. Selección de
modelos. Ejercitación.
